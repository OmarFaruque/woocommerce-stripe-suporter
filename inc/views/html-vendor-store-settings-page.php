	...
	<form id="wcpv-vendor-settings" action="" method="post">
		...
		<table class="form-table">
			<tbody>
				...
				<tr class="form-field">
					<th scope="row" valign="top"><label for="wcpv-vendor-publickey"><?php esc_html_e( 'Stripe Public Key', 'woocommerce-product-vendors' ); ?></label></th>

					<td>
						<input type="text" id="wcpv-vendor-publickey" name="vendor_data[publickey]" value="<?php echo esc_attr( $publickey ); ?>" />
					</td>
				</tr>

				<tr class="form-field">
					<th scope="row" valign="top"><label for="wcpv-vendor-secretkey"><?php esc_html_e( 'Stripe Secret Key', 'woocommerce-product-vendors' ); ?></label></th>

					<td>
						<input type="text" id="wcpv-vendor-secretkey" name="vendor_data[secretkey]" value="<?php echo esc_attr( $secretkey ); ?>" />
					</td>
				</tr>
